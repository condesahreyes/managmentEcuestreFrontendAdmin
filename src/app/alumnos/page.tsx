...
import { Users, Ban, CheckCircle, Mail, Phone, Search, Plus, X, Package, Eye, Calendar } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <select
              ...
              className="w-full sm:w-auto px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-white/20 focus:bg-white/10 backdrop-blur-sm text-gray-900 bg-white"
            >
              <option value="activos" className="bg-[#1a1a1a]">Activos</option>
              <option value="inactivos" className="bg-[#1a1a1a]">Inactivos</option>
              <option value="todos" className="bg-[#1a1a1a]">Todos</option>
            </select>
          </div>
        </div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-white/60 mt-1">{alumno.email}</div>
                        {alumno.telefono && (
                    ...
                    {suscripcion && (
                      <div className="text-sm text-white/60">
                        {suscripcion.clases_usadas}/{suscripcion.clases_incluidas} clases usadas
                      </div>
                    )}
                    <div className="grid grid-cols-3 gap-2 pt-2 border-t border-white/10">
                      ...
                      >
                        {alumno.activo ? <Ban className="w-4 h-4" /> : <CheckCircle className="w-4 h-4" />}
                      </button>
                    </div>
                  </div>
                );
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 md:p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4 md:mb-6">
                <div>
                  ...
                  <p className="text-white/60 mt-1 text-sm">Detalles del Alumno</p>
                </div>
                <button
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    <div>
                      ...
                      <p className="text-white text-sm md:text-base">{alumnoDetalle.nombre}</p>
                    </div>
                    <div>
                      <p className="text-xs font-medium text-white/50 mb-1">Apellido</p>
                      <p className="text-white text-sm md:text-base">{alumnoDetalle.apellido}</p>
                    </div>
                    <div>
                      ...
                      <p className="text-white text-sm md:text-base break-all">{alumnoDetalle.email}</p>
                    </div>
                    {alumnoDetalle.telefono && (
                      <div>
                        ...
                        <p className="text-white text-sm md:text-base">{alumnoDetalle.telefono}</p>
                      </div>
                    )}
                    <div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5">
                  ...
                  {alumnoDetalle.suscripciones && alumnoDetalle.suscripciones.length > 0 ? (
                    <div className="space-y-3">
                      {alumnoDetalle.suscripciones.map((suscripcion) => (
                        <div
                          key={suscripcion.id}
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-3 mt-3 text-sm">
                            <div>
                              <p className="text-xs font-medium text-white/50 mb-1">Clases</p>
                              <p className="text-white">
                                {suscripcion.clases_usadas}/{suscripcion.clases_incluidas} usadas
                              </p>
                            </div>
                            <div>
                              <p className="text-xs font-medium text-white/50 mb-1 flex items-center space-x-1">
                              ...
                              <p className="text-white text-xs">
                                {format(parseISO(suscripcion.fecha_inicio), 'dd MMM yyyy', { locale: es })} -{' '}
                                {format(parseISO(suscripcion.fecha_fin), 'dd MMM yyyy', { locale: es })}
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <p className="text-sm text-white/50 italic">No tiene suscripciones asignadas</p>
                  )}
                </div>
